...
/**
 * Error boundary for the workflows section.
 */
export default function WorkflowsError({ error, reset }: ErrorProps) {
    useEffect(() => {
        logger.error('Workflows error:', {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[600px] p-8 text-center">
            ...
            <h2 className="text-2xl font-semibold mb-2">Workflow Error</h2>
            <p className="text-muted-foreground mb-6 max-w-md">
                There was a problem loading your workflow. This could be due to a network issue or invalid workflow data.
            </p>
